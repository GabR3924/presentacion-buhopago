...
import ModeloEconomico from '@/components/seccion-2/ModeloEconomico';
import CitasAPA from '@/components/common/CitasAPA';
import { referenciasSeccion2 } from '@/data/seccion-2/modeloEconomico';
    ...
    <div className="min-h-screen bg-gray-50">
      <nav className="bg-white shadow-lg">
        <div className="container mx-auto px-6 py-4 flex items-center justify-between">
          <Link href="/seccion-1" className="text-primary-600 hover:text-primary-700 flex items-center">
      ...
      <CitasAPA referencias={referenciasSeccion2} />
    </div>
  );
}
